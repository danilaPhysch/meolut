...
public class RinexBeidouEphemerisConfiguration : IEntityTypeConfiguration<RinexBeidouEphemeris>
{
    public void Configure(EntityTypeBuilder<RinexBeidouEphemeris> builder)
    {
        ...
        // BeiDou специфичные поля
        builder.Property(e => e.Aode).HasPrecision(15, 12);
        ...
        builder.Property(e => e.Spare1).HasPrecision(15, 12);
        builder.Property(e => e.BdtWeek).HasPrecision(15, 12);
        builder.Property(e => e.Spare2).HasPrecision(15, 12);
        builder.Property(e => e.SvAccuracy).HasPrecision(15, 12);
        builder.Property(e => e.SatH1).HasPrecision(15, 12);
        builder.Property(e => e.Tgd1).HasPrecision(15, 12);
        builder.Property(e => e.Tgd2).HasPrecision(15, 12);
        builder.Property(e => e.TransmissionTime).HasPrecision(15, 12);
        builder.Property(e => e.Aodc).HasPrecision(15, 12);
    }
}